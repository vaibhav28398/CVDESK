...
.top{
  ...
  <body>
      ...
      <div class="profile1">
        <div class="col-sm-4"><center><?php echo"<img class='img-circle profileimg' src='pics/".$image."'>"; ?></center></div>
        <div class="col-sm-8">
     ...
     <div class="professional"><?php echo $professionskills; ?></div><br>
