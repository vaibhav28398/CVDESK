...
<html>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand active" href="member.php">CVDESK</a>
    </div>
...
<br>
  ...
  <div style="font:bold normal 30px cursive;margin-left:80%"><p>About Us</p></div>
  
  <p><div style="font:normal normal 30px cursive">Create beautiful,professional resumes in <br/>minutes,<strong>free</strong>.</div></p>
  ...
  <div class="one"><h1 style="text-align:center; padding:10px">more than 800<br/>CV</h1></div>
  <div class="one"><h1 style="text-align:center; padding:10px">more than 800<br/>themes</h1></div>
  <div class="one"><h1 style="text-align:center; padding:10px">more than 800<br/>text</h1></div>
  </div>

  <div class="para">
<h1 style="font:bold normal 40px cursive">About Us</h1>
